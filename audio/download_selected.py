...
selected = ['2022-06-24', '2022-06-25', '2022-06-26', '2022-06-27', '2022-06-28', 
...
if args.option == 'Date_Range' or args.option == 'All':
    ...
    for location in locations:
        ...
        for selected_date in selected:
            year, month, day = selected_date[:4], selected_date[5:7], selected_date[8:10]
            audio_path = f'{location}/{year}/{int(month)}/{month}-{day}-{year[-2:]}_audio'
            print(audio_path)
            download_file_from_bucket(client, bucket_name, args.save_dir, audio_path)
